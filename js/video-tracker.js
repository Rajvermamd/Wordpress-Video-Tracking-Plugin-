// function sendProgress(videoId, percent) {
//     fetch(vt_ajax_object.ajax_url, {
//         method: "POST",
//         headers: { "Content-Type": "application/x-www-form-urlencoded" },
//         body: `action=save_video_progress&video_id=${encodeURIComponent(videoId)}&percent=${percent}`
//     });
// }

// document.addEventListener("DOMContentLoaded", () => {
//     // Track <video> tags (self-hosted)
...
//             if (percent - lastTracked >= 10) {
//                 lastTracked = percent;
//                 sendProgress(videoId, Math.floor(percent));
//             }
//         });
//     });
...
//     document.querySelectorAll(".youtube-player").forEach((div, index) => {
